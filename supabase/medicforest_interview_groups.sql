-- Run in the Supabase SQL editor after medicforest_interview_platform.sql and
-- medicforest_interview_question_progress.sql.
...
comment on function public.interview_groups_action(text, uuid, jsonb) is
  'Authenticated group operations. Membership and host checks run inside serialized mutations. Member rank uses completed interview question-bank questions.';
