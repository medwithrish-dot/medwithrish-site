...
const { interviewGuides, searchInterviewGuides, guidesForInterviewQuestion } = loadData("app/phloemai/interviews/_data/interviewGuides.ts");
const { INTERVIEW_QUESTIONS, INTERVIEW_QUESTION_SUBCATEGORIES, INTERVIEW_QUESTION_CATEGORIES } = loadData("app/phloemai/interviews/_data/interviewQuestionBank.ts");
...
test("guide public sources are official and public university data contains no prep-company links", () => {
  ...
  const { interviewUniversities } = loadData("app/phloemai/interviews/_data/universities.ts");
