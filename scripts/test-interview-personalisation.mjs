...
const { interviewerSpeech, answerConversation } = load(resolve(root, "app/phloemai/interviews/_lib/interviewer-transcript"));
const { questionTransition, DONE_PROMPT } = load(resolve(root, "app/phloemai/interviews/_lib/station-flow"));
const { standardInterviewUniversities, universityStationPresets, universityStationSlugs } = load(resolve(root, "app/phloemai/interviews/_data/university-stations"));
const { interviewStations } = load(resolve(root, "app/phloemai/interviews/_data/interview-stations"));
