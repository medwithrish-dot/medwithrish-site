...
export const metadata: Metadata = {
  title: "UCAT Groups | MedicForest",
  description: "Community practice groups for MedicForest UCAT preparation.",
};
...
export default function Page() {
  return (
    <main className="medicforest-dashboard-compact min-h-screen bg-[#eef1f3] px-5 py-7 text-[#071923] sm:px-6 lg:px-8">
