...
// public/medicforest/interview-question-markscheme-rubrics.txt, and interviewGuides.ts.
...
export function getStationReviewGuidance(stationSlug: string): StationReviewGuidance | null {
  ...
  return {
    ...
    sourceLabel: "MedicForest practice framework and question-bank rubric",
  };
}
