...
const sectionPages = {
  ...
  "question-bank": {
    ...
    cards: [
      {
        title: "Motivation",
        description: "Personal why, work experience and reflection prompts.",
        href: "/phloemai/interviews/stations/motivation-question",
        action: "Open prompts",
      },
      {
        title: "NHS hot topics",
        description: "Waiting lists, strikes, workforce and public health.",
        href: "/phloemai/interviews/stations/nhs-waiting-lists",
        action: "Open prompts",
      },
      {
        title: "University prompts",
        description: "Question styles grouped by medical school.",
        href: "/phloemai/interviews/universities",
