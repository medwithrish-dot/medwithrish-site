...
export function InterviewStationPathway({ stations, userId, initialCompleted, available, isPremium }: Props) {
  ...
  return <div className={styles.pathway}>
    ...
    <p className={styles.storageNote}>{userId ? "Your progress is saved to your account and does not reset each day." : <>Guest progress stays in this browser and does not reset each day. <Link href="/phloemai/account">Sign in</Link> to start a pathway saved to your account.</>}</p>
