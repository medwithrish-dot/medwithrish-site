...
// Research provenance is retained in docs/interview-university-sources.md. Public links use official admissions sources.
...
export const interviewUniversities: readonly InterviewUniversity[] = [
  university("aberdeen", "University of Aberdeen", "https://www.abdn.ac.uk/smmsn/", {
    ...
    timingNote: "Available format guidance reports six 5-minute stations. This rehearsal adds no separate reading time or interval because these are not specified in the current format summary. Older example timings on the guide differ; follow your invitation.",
  }),
  university("aston", "Aston University", "https://www.aston.ac.uk/hls/aston-medical-school", {
    timingNote: "Available format guidance reports online MMI stations lasting 8 minutes, without a fixed station count. This rehearsal uses five stations and 2-minute intervals as practice settings.",
  }),
  university("anglia-ruskin", "Anglia Ruskin University", "https://www.aru.ac.uk/health-education-medicine-and-social-care/medicine", {
    ...
    timingNote: "Available format guidance describes six 7-minute interviews with 1 minute of reading before each, citing ARU admissions. Reading is the transition period here; there is no additional rest timer.",
  }),
  university("birmingham", "University of Birmingham", "https://www.birmingham.ac.uk/university/colleges/mds/index.aspx", {
    ...
    timingNote: "Available format guidance reports six or seven stations, each with 6 minutes of discussion and 2 minutes of reading. This rehearsal chooses seven. International arrangements and the separate calculation assessment differ.",
  }),
  ...
  university("buckingham", "University of Buckingham", "https://medvle.buckingham.ac.uk/", {
    stationCount: 4,
    timingNote: "Available format guidance describes an MMI after a separate Multiple Mini Assessment. Four 8-minute stations are reported by third parties but unconfirmed by the university; these and the 2-minute intervals are practice settings.",
  }),
  ...
  university("cardiff", "Cardiff University", "https://www.cardiff.ac.uk/medicine", {
    ...
    timingNote: "Available format guidance confirms MMI but says Cardiff does not publish fixed station counts or durations. Nine 6-minute stations are indicative third-party figures; the 2-minute intervals are practice settings.",
  }),
  university("city-st-georges", "City St George’s, University of London", "https://www.sgul.ac.uk/", {
    ...
    timingNote: "Available format guidance describes six online stations of about 5 minutes, including the question being read aloud, with 60 seconds between them. This preset covers A100; other routes may differ.",
  }),
  ...
  university("east-anglia", "University of East Anglia", "https://www.uea.ac.uk/medicine", {
    ...
    timingNote: "Available format guidance reports six stations with about 5 minutes of answering and 90 seconds of reading, but identifies the figures as application-guide timings requiring confirmation for your cycle. This rehearsal follows those indicative timings.",
  }),
  university("edge-hill", "Edge Hill University", "https://www.edgehill.ac.uk/course/medicine/", {
    timingNote: "Available format guidance confirms MMI but explicitly says the station count and durations are not officially published. Five 8-minute stations with 2-minute intervals are practice settings.",
  }),
  university("edinburgh", "University of Edinburgh", "https://www.ed.ac.uk/", {
    format: "Mixed",
    timingNote: "Edinburgh holds an assessment day with a series of short interviews. Available format guidance says exact counts and durations are not published. Five 8-minute discussions with 2-minute intervals are a practice circuit, not the full assessment day.",
  }),
  university("exeter", "University of Exeter", "https://medicine.exeter.ac.uk/", {
    stationCount: 5, stationSeconds: 300,
    timingNote: "Available format guidance describes MMI; station counts vary between older official information and current third-party reports. Five 5-minute stations with 2-minute intervals are indicative practice settings. Check the current BMBS admissions policy.",
  }),
  ...
  university("imperial-college-london", "Imperial College London", "https://www.imperial.ac.uk/medicine/", {
    ...
    timingNote: "Available format guidance describes seven 5-minute stations, with around 1 minute to read the next briefing. The reading period acts as the transition; no additional rest interval is added.",
  }),
  university("keele", "Keele University", "https://www.keele.ac.uk/medicine/", {
    format: "Panel", stationCount: 2, stationSeconds: 900,
    timingNote: "Available format guidance reports two separate 15-minute online panel interviews, usually in the same half-day. This rehearsal uses those lengths with a 2-minute practice interval; the real interval is allocated by Keele.",
  }),
  university("kings-college-london", "King’s College London", "https://www.kcl.ac.uk/lsm/index.aspx", {
    ...
    timingNote: "Available format guidance cites seven online MMI stations for A100, but no officially published duration. Six minutes of answering and 2-minute intervals are practice settings. Other King's routes may have different arrangements.",
  }),
  university("lancashire", "University of Lancashire", "https://www.lancashire.ac.uk/schools/medicine-dentistry", {
    ...
    timingNote: "Formerly UCLan. Available format guidance cites an official range of six to ten MMI stations; eight stations of around 7 minutes are third-party figures. This rehearsal uses those indicative figures with 2-minute practice intervals.",
  }),
  university("lancaster", "Lancaster University", "https://www.lancaster.ac.uk/lms/", {
    stationCount: 12, stationSeconds: 300, breakSeconds: 0,
    timingNote: "Available format guidance cites 12–15 online stations of approximately 5 minutes, including tasks and preparation stations. This rehearsal chooses twelve answer stations without additional intervals; it does not reproduce Lancaster's task/preparation sequence.",
  }),
  university("leeds", "University of Leeds", "https://medicinehealth.leeds.ac.uk/medicine", {
    ...
    timingNote: "Available format guidance says the count and duration are not officially fixed; eight 6-minute stations are indicative, with 2 minutes of reading described in its guidance. This is a practice preset requiring confirmation against your invitation.",
  }),
  university("leicester", "University of Leicester", "https://le.ac.uk/medicine", {
    stationCount: 7, stationSeconds: 600, breakSeconds: 0,
    timingNote: "Available format guidance cites seven stations of about 10 minutes for on-campus interviews. This rehearsal allocates the full block to answers because the reading/discussion split is unspecified. International online interviews and numeracy arrangements differ.",
  }),
  university("liverpool", "University of Liverpool", "https://www.liverpool.ac.uk/medicine/", {
    timingNote: "Available format guidance confirms MMI, on campus for home applicants and online for international applicants, but no published fixed count or duration. Five 8-minute stations with 2-minute intervals are practice settings.",
  }),
  ...
  university("newcastle", "Newcastle University", "https://www.ncl.ac.uk/undergraduate/degrees/a100/", {
    ...
    timingNote: "Available format guidance reports seven 7-minute MMI stations, including role-play. A 2-minute interval is a practice addition because the cited timing summary does not specify the transition length; applicant routes may differ.",
  }),
  ...
  university("plymouth", "University of Plymouth", "https://www.plymouth.ac.uk/schools/peninsula-medical-school", {
    timingNote: "Available format guidance describes MMI and indicative reports of about five stations, but says official counts and lengths are not fixed publicly. Five 8-minute stations with 2-minute intervals are practice settings.",
  }),
  ...
  university("queens-belfast", "Queen’s University Belfast", "https://www.qub.ac.uk/schools/mdbs/", {
    ...
    timingNote: "Available format guidance reports nine in-person stations for home applicants and seven online for international applicants. This home-route rehearsal uses 5-minute answers and 1-minute preparation as practice choices; the source does not confirm station durations.",
  }),
  university("sheffield", "University of Sheffield", "https://www.sheffield.ac.uk/medicine", {
    ...
    timingNote: "Available format guidance describes eight MMI sections for home applicants and an online panel for international A100 applicants. This home-route rehearsal uses 8-minute stations and 2-minute intervals as practice choices; official durations are not published.",
  }),
  university("southampton", "University of Southampton", "https://www.southampton.ac.uk/medicine", {
    ...
    timingNote: "Available format guidance describes a panel of around 20 minutes and a group discussion of 20–30 minutes. This rehearsal chooses two 20-minute blocks and a 2-minute interval. Use Groups to practise discussion; the solo interviewer cannot reproduce a real group task.",
  }),
  university("sunderland", "University of Sunderland", "https://www.sunderland.ac.uk/study/medicine/", {
    stationCount: 6,
    timingNote: "Available format guidance confirms in-person MMI and cites six stations for an earlier cycle, without current fixed timings. Six 8-minute stations and 2-minute intervals are practice choices. The separate numeracy assessment is not included.",
  }),
  ...
  university("ucl", "University College London", "https://www.ucl.ac.uk/medical-school/", {
    ...
    timingNote: "Available format guidance describes up to eight 5-minute stations with about 1 minute to read each briefing and 2–3 questions per station. This rehearsal selects eight; your invitation sets the actual count.",
  }),
  university("ulster", "Ulster University", "https://www.ulster.ac.uk/courses/202627/medicine-41407/", {
    ...
    timingNote: "Available format guidance confirms a graduate-entry MMI but says station count and duration are not officially published. Eight stations is indicative; 8-minute answers and 2-minute intervals are practice choices.",
  }),
  university("warwick", "University of Warwick", "https://warwick.ac.uk/fac/med", {
    stationCount: 6, stationSeconds: 600, breakSeconds: 0,
    timingNote: "Available format guidance cites six graduate-entry MMI stations of approximately 10 minutes. This rehearsal gives each block to discussion because a separate reading/rest split is not specified in the source.",
  }),
  university("brighton-sussex", "Brighton and Sussex Medical School", "https://www.bsms.ac.uk/index.aspx", {
    ...
    timingNote: "Joint Brighton and Sussex programme. Available format guidance reports five 10-minute stations with a short break between them. The rehearsal chooses a 2-minute interval because the break length is unspecified.",
  }),
  university("kent-medway", "Kent and Medway Medical School", "https://kmms.ac.uk/", {
    ...
    timingNote: "Joint Canterbury Christ Church and Kent programme. Available format guidance cites previous six 7-minute stations with 3-minute intervals plus an approximately 40-minute group task, with current counts unconfirmed. This rehearsal covers the six short stations; use Groups for group practice.",
  }),
  ...
  university("hull-york", "Hull York Medical School", "https://www.hyms.ac.uk/", {
    ...
    timingNote: "Joint Hull and York programme. Available format guidance describes two mini-interviews, a group exercise, a scenario and a student station for home applicants. Five 8-minute blocks with 2-minute intervals are practice allocations; actual durations and international arrangements differ.",
  }),
];
