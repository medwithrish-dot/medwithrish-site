...
const questionBankPath = "/phloemai/interview/question-bank";
...
function QuestionPracticeView({
  ...
  return (
    <main className="phloem-dashboard-compact min-h-screen bg-[#eef1f3] text-[#071923] lg:fixed lg:inset-0 lg:h-auto lg:overflow-hidden">
