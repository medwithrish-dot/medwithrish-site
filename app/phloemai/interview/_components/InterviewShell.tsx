...
export async function InterviewShell({
  ...
  return (
    <main data-interview-shell className="phloem-dashboard-compact flex-1 bg-[#eef1f3] text-[#071923] lg:fixed lg:inset-0 lg:h-[100dvh] lg:overflow-hidden">
          ...
          <section id="interview-content" className="mx-auto w-full max-w-[1600px] px-5 py-7 sm:px-7 lg:px-9 lg:py-9">
            <header className={`flex flex-col gap-5 sm:flex-row sm:justify-between ${heroHeader ? "sm:items-center" : "border-b border-[#d3dfe1] pb-7 sm:items-start"}`}>
              <div className="min-w-0">
                {activeLabel !== "Dashboard" && <Link href="/phloemai/interview/dashboard" className="inline-flex items-center gap-2 text-xs font-bold text-[#08787b] hover:text-[#042724]">
