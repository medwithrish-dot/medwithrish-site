    ...
    <section className="rounded-2xl bg-[#042724] p-6 text-white sm:p-8">
      <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
        <div><p className="text-xs font-semibold text-[#9ce8dd]">Try the AI interview for free</p>
          ...
          <Link href="/phloemai/interview/ai-interviews?station=why-medicine" className="mt-5 inline-flex items-center gap-3 rounded-xl bg-[#b9f4db] px-5 py-3 text-sm font-bold text-[#042724] hover:bg-white">Try the free AI interview <ArrowRight size={17} /></Link>
        </div>
