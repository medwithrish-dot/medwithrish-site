...
export function AIInterviewReview({ attempt, preview = false, configured, busy = false, onGenerate, onRetry, onNext, breakRemaining = 0 }: Props) {
  ...
  return <div className={styles.review} data-station-review>
    <div className={styles.toolbar}>
      {needsSaving ? <span className={styles.disabledLink} aria-disabled="true"><ArrowLeft size={16} /> Saved interviews</span> : <Link href="/phloemai/interview/reports"><ArrowLeft size={16} /> Saved interviews</Link>}
