...
export const metadata: Metadata = {
  ...
  title: "MedicForest Disclaimer | MedWithRish",
  description: "Important limits for MedicForest AI feedback, data collection and UCAT preparation.",
};
...
const points = [
  ...
  },
  {
    ...
    text: "When you mark a set, MedicForest can save answers, timings, answer switches, flags, calculator usage, keyboard shortcuts, navigation activity and overall session results.",
  },
  {
    title: "Independent from exam bodies",
    text: "MedicForest is independent and is not endorsed by or affiliated with the UCAT Consortium, Pearson VUE, universities or medical/dental schools.",
  },
];
      ...
      <div className="mx-auto max-w-4xl px-5 py-10">
        ...
        <header className="mt-8 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-3 text-sm font-semibold leading-6 text-slate-600">
            Last updated: 7 May 2026. This explains the main limits of MedicForest
            feedback and data use before you use the tutor.
          </p>
        </header>
